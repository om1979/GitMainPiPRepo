...
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblPonderadoFinal
...
--SELECT * FROM [VIA-MXSQL].MxFixIncome.dbo.itblPonderado
--WHERE dteDate = '20141217'
--AND intPlazo =36



--spi_Auditoria_Licuadora;1 '20141217','22','BI'
...
SELECT * FROM  dbo.itblPonderado_BidAsk 
SELECT * FROM  itblPonderadoFinal_BidAsk
WHERE  intPlazo = 93

SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblPonderadoFinal
WHERE dteDate = '20150310'
AND intPlazo = 93


SELECT * FROM  SYS.procedures
WHERE name LIKE '%estOaceves%'

TRUNCATE TABLE itblPonderado_BidAsk
TRUNCATE TABLE itblPonderadoFinal_BidAsk

--spi_LicuadoFinalTestOaceves '20141124','CET',1,'Ask'
--go
...
--ALTER  PROCEDURE dbo.spi_LicuadoFinalTestOaceves
   -- @txtDate AS VARCHAR(10)
   --,@txtCategory AS CHAR(4)
   --,@fMatFlag AS BIT = 0
   --, @txtBlenderFlag VARCHAR(10)= ''
--AS 

   DECLARE  @txtDate AS VARCHAR(10) = '20150310'
   DECLARE  @txtCategory AS CHAR(4) = 'CET'
   DECLARE  @fMatFlag AS BIT = 0
...
/*	
	...
	licuadora_BidAsk_Guber
	Modifica: Omar Adrian Aceves Gutierrez
	Fecha: 2014-11-25 19:02:30.137 
	Descripcion:Se agrega @txtBlenderFlag para procesar datos de licuadora BidAsk que escriben 
				a itblPonderado_BidAsk y itblPonderadoFinal_BidAsk
*/
 ...
 END
	...
	-- Elimino para insertar itblPonderado 
        ...
        WHERE
            ...
            AND @txtBlenderFlag NOT IN ('Bid','Ask')
	...
	-- Inserto en itblPonderado
        ...
        INSERT  dbo.itblPonderado
                ...
                FROM
                    ...
                    WHERE  @txtBlenderFlag NOT IN ('Bid','Ask')
                    
                    
              IF(@txtBlenderFlag IN ('Bid','Ask') )
					BEGIN 
		...
		-- De las horas maximas tomamos la que empezo despues
                ...
                INSERT  #tblMaxBeginTime
                        ...
                        FROM
                            #tblMaxEndTime t
                            INNER JOIN itblPonderado p ( NOLOCK ) ON t.txtTv = p.txtTv
                                                              AND t.intPlazo = p.intPlazo
			...
			-- Si tenemos subasta tomamos el nivel
                ...
                INSERT  itblPonderadoFinal
                        ...
                        FROM
                            ...
                            LEFT OUTER JOIN itblPonderadoFinal f ( NOLOCK ) ON t.txtTv = f.txtTv
		...
		-- Para posturas actualizo la hora de fin hasta el cierre
                ...
                SET 
                    i.dteEndHour = @dteEnd
                FROM
                    itblPonderado i ( NOLOCK )
                    INNER JOIN #tblTimes t ON i.txtTv = t.txtTv
                             AND i.intPlazo = t.intPlazo
                    LEFT OUTER JOIN itblPonderado ih ( NOLOCK ) ON i.intPlazo = ih.intPlazo
			...
			-- Si tenemos subasta tomamos el nivel
                ...
                INSERT  itblPonderadoFinal
                 ...
                 INSERT  itblPonderadoFinal_BidAsk
                        ...
                        FROM
                            #itblCorroPonderado
                            WHERE @txtBlenderFlag    IN ('Bid','Ask')
                        GROUP BY
                            txtTv
                           ,intPlazo
                        ORDER BY
		...
		-- Ajusto la el nivel de los nodos con subasta
                ...
                INSERT  #itblCorroPonderadoSubastas
                        ...
                        FROM
                            ...
                            LEFT OUTER JOIN itblPonderado h ( NOLOCK ) ON s.txtTv = h.txtTv
                ...
                FROM
                    ...
                    INNER JOIN itblPonderadoFinal p ON s.txtTv = p.txtTv
...
--TRUNCATE TABLE itblNodesYTMCatalog

--INSERT INTO itblBlenderParams
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblBlenderParams

--INSERT INTO itblParametrosLicuadora
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblParametrosLicuadora
...
--INSERT INTO itblCategoryTvs
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblCategoryTvs




--SELECT * FROM  tblBondsPricesRange
--ORDER BY 5 desc

--INSERT INTO tblBondsPricesRange
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.tblBondsPricesRange
--WHERE dteDate > '2015-02-05 00:00:00.000'
		



--INSERT INTO itblNodesYTMCatalog
...
--,AAA.fConfig
--,AAA.fInterpolate
-- FROM  [VIA-MXSQL].MxFixIncome.dbo.itblNodesYTMCatalog AS AAA
--FULL OUTER JOIN itblNodesYTMCatalog AS bbb
--ON AAA.intSerialYTM = bbb.intSerialYTM
--WHERE bbb.txtId1 IS NULL 
  
----WHERE intSerialYTM IN 
----(
----1097
----,1098
----,1099
...
----truncate table dbo.itblPonderadoFinal
----WHERE dteDate = '20150310'

--INSERT INTO itblPonderado
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblPonderado
--WHERE dteDate = '20150309'



--INSERT INTO itblPonderadoFinal
--SELECT * FROM  [VIA-MXSQL].MxFixIncome.dbo.itblPonderadoFinal
--WHERE dteDate = '20150309'
