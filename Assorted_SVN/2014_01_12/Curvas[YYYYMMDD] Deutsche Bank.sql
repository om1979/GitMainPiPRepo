...
--UPDATE tblActiveX 
--SET txtValor = '\\PIPMXSQL\PRODUCCION\MXVPRECIOS\Productos\Definitivo\HSBC\Actual\ '
--WHERE txtValor = '\\pipmxsql\pruebas\MxVprecios\Productos\Definitivo\Bloomberg\Actual\'
--AND txtProceso = 'HSBC_CURVES'
...
--INNER JOIN SYSCOMMENTS B(NOLOCK)
--ON 
-- A.Id = B.Id
--WHERE 
-- B.Text LIKE '%TasasPiPBital%'





--\\PIPMXSQL\PRODUCCION\MXVPRECIOS\Productos\Definitivo\HSBC\Actual\  ---original 
--\\pipmxsql\pruebas\MxVprecios\Productos\Definitivo\Bloomberg\Actual\ --- pruebas 
...
--ALTER  PROCEDURE dbo.sp_productos_BITAL;7 
-- 	@txtDate AS DATETIME
...
/*SE AGREGAN AL GENERICO 4 CURVAS*/
		SELECT 'Sheet1' AS [SheetName], 89 AS [Col],'Implícita en Fwd de Euro en Pesos'  AS [Header],'CURVES' AS [Source],'FWD'    AS [Type],'EUM'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad] UNION 
		SELECT 'Sheet1' AS [SheetName], 90 AS [Col],'Curva OIS en Dólares'  AS [Header],'CURVES' AS [Source],'OIS'    AS [Type],'USD'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad] UNION 
		SELECT 'Sheet1' AS [SheetName], 91 AS [Col],'Descuento Libor 1 Mes'  AS [Header],'CURVES' AS [Source],'LBZ'    AS [Type],'US1'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad] UNION 
		SELECT 'Sheet1' AS [SheetName], 92 AS [Col],'Descuento Libor 6 Meses'  AS [Header],'CURVES' AS [Source],'LBZ'    AS [Type],'US6'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad]  
