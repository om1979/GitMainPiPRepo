...
-- Descripcion Modulo 24: GENERAR PRODUCTO COVAF_MANDATOS_MSCI_EURO_PIP  
  
-- Autor:     Mike Ramirez  
-- Fecha Creacion:   2014-07-14 11:14:25.133  
-- Descripcion Modulo 24: Se agrega un nuevo caso para la columna región  

-- Modifica:        Omar Adrian Aceves Gutierrez 
-- Fecha Creacion:  2014-10-30 12:09:00.253  
-- Descripcion Modulo 24: se agrega validacion para poner razon social en mayusculas/ sin acentos/ ni apostrofes  

--------------------------------------------------------------------------   
ALTER   PROCEDURE [dbo].[usp_productos_PiPGenericos];24  
  --DECLARE   
  @txtDate AS DATETIME   
  --= '20141030'  
