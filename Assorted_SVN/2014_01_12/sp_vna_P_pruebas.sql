 ...
 /*  
  ...
  para que tome el tipo de cambio de Udi del dia "2007-09-19 00:00:00.000"  
    ...
    v.1.3 Oaceves 2014-07-02 10:13:20.817
    se comentan las restricciones donde ( da.txtId1 es nulo)
    
*/  
  
-- para obtener los insumos  
ALTER   PROCEDURE [dbo].[sp_analytic_vna_p]  
 --DECLARE   
 @txtDate AS VARCHAR (10) ,--= '20140425'--,  
-- DECLARE    
@txtAnalytic AS VARCHAR(10)-- = 'VNA_P'  
AS  
BEGIN  
