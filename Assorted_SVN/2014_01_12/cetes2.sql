...
----obtiene elementos marcados en un color 
--spi_ENCUESTAS;9   '20140923','cet'

--spi_ENCUESTAS;1   '20140923','cet'
...
--CREATE PROCEDURE dbo.spi_ENCUESTAS;1  
 DECLARE @txtDate AS VARCHAR(10) = '20140930'  
...
-- -- reporte: instrumentos  
 ...
 AND  c.dteMaturity >= @txtDate  
  ...
  --WHERE dteDate = '20140915'
  --AND intSerialYTM = 1059
