...
--se hacen nuevos cambios en producto



--GS_VectorAnalitico[DATE|YYYYMMDD]24H.csv
...
--WHERE txtProduct = 'GS_VectorAnalítico_24H_XLS'

--SELECT * FROM MxProcesses..tblProductGeneratorMap
--WHERE txtProduct = 'GS_VectorAnalítico_MD_XLS'


--INSERT INTO MxProcesses..tblProductGeneratorMap
--VALUES('GS_VectorAnalítico_MD_XLS','PRECIOS','PREVIO_2',6,'GldMS',1)
...
--WHERE txtPack LIKE '%previo%'


--SELECT * FROM  MxProcesses..tblOwnersCatalog
--WHERE txtDescription LIKE '%sa%'


--INSERT INTO MxProcesses..tblOwnersCatalog
--VALUES('GldMS','Goldman Sachs')
...
----------------------------------------   
*/        
    ALTER    PROCEDURE dbo.usp_productos_GoldmanSachs;4 '20140826','md'
    
    @dtedate DATETIME, --= '20140825'         
    @txtliqtype VARCHAR(5) --= 'md'      
...
ON        
 ...
 VALUES  (       
  ...
  +'LIQUIDEZ'+','+ 'CAMBIO DIARIO'+','+ 'CAMBIO SEMANAL'+','+ 'PRECIO MAX 12M'+','+ 'PRECIO MIN 12M'+','+ 'SUSPENSION'+','+ 'VOLATILIDAD'+','+ 'VOLATILIDAD 2'+','+ 'DURACION'+','+ 'DURACION MONET.'+','+ 'CONVEXIDAD'+','+ 'VAR'+','+ 'DESVIACION STAND'+','
  + 'VALOR NOMINAL ACTUALIZADO'+','+ 'CALIFICACION FITCH'+','+ 'FECHA PRECIO MAXIMO'+','+ 'FECHA PRECIO MINIMO'+','+ 'SENSIBILIDAD'+','+ 'DURACION MACAULAY'+','+ 'TASA DE RENDIMIENTO'+','+ 'HR RATINGS'+','+ 'DURACION EFECTIVA'+','+ 'ISIN'+','
  + 'Precio Sucio MO'+','+'Precio Limpio MO'+','+'Intereses Acumulados MO')      
