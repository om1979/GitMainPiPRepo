...
-- DECLARE    @txtDate AS DATETIME   = '20141015'  
...
--        THEN '0000000000'  
--       ELSE  
--         STR(ROUND(txtVCT,8),10,8) + REPLICATE('0',10 -LEN(STR(ROUND(txtVCT,8),10,8))) 
--      END +  
     ...
     -- END +  
      ...
      CASE   
       WHEN txtVCT IS NULL  
        THEN '0000000000'  
       ELSE  
       txtVCT --STR(ROUND(txtVCT,8),10,8) + REPLICATE('0',10 -LEN(STR(ROUND(txtVCT,8),10,8)))
      END --+  
...
--SELECT 
--SUBSTRING(STR(ROUND('0.00628978',6),11,6),1,4) + 
--SUBSTRING(STR(ROUND('0.00628978',8),11,8),4,16)  
--IMPRIME    0.00796561 DE 000628978
...
--CORRECTO CAMBIA PUNTO POR 0 

--SELECT 
-- SUBSTRING(REPLACE(STR(ROUND('226.00116668',6),11,8),' ','0'),1,2)
--  + SUBSTRING(STR(ROUND('622.00116668',8),11,8),4,16) 
