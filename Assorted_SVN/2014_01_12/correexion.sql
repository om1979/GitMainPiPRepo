 ...
 --alter  PROCEDURE dbo.usp_productos_INGAFORE;3 
...
--DECLARE
 @txtDate AS VARCHAR(10), --= '20140515'
 --DECLARE 
...
------------------------------------------------------------------------------------------------
--IF OBJECT_ID('tempdb..#tbl_tmpData') IS NOT NULL
--DROP TABLE #tbl_tmpData

--IF OBJECT_ID('tempdb..@latestPricesAdd') IS NOT NULL
--DROP TABLE @latestPricesAdd
	...
	WHERE
		...
		--INNER JOIN   @latestPricesAdd AS B
