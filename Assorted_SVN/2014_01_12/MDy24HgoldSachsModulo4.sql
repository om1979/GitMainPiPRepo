...
/*  
  ...
  Descripcion: para 24 csv  
-----------------------------------------------------------------------------------------    
*/    
    ALTER      PROCEDURE dbo.usp_productos_GoldmanSachs;4    

   @dtedate DATETIME , --= '20140819'     
   @txtliqtype VARCHAR(5) --= '24H'  
...
ON    
 ...
 INSERT INTO @temptittle  
         ( lineas )  
 VALUES  (   
  'FECHA'+','+ 'TIPO VALOR'+','+ 'EMISORA'+','+ 'SERIE'+','+ 'PRECIO LIMPIO'+','+ 'PRECIO SUCIO'+','+ 'INTERESES ACUMULADOS'+','+ 'CUPON ACTUAL'+','+ 'SOBRETASA'+','+ 'NOMBRE COMPLETO'+','+ 'SECTOR'+','+ 'MONTO EMITIDO'+','+ 'MONTO EN CIRCULACION'+','+ 'FECHA EMISION'+','+ 'PLAZO EMISION'+','+ 'FECHA VCTO'+','+ 'VALOR NOMINAL'+','+ 'MONEDA EMISION'+','+ 'SUBYACENTE'+','+ 'REND. COLOCACION'+','+ 'ST COLOCACION'+','+ 'FREC. CPN'+','+ 'TASA CUPON'+','+ 'DIAS TRANSC. CPN'+','+ 'REGLA CUPON'+','+ 'CUPONES EMISION'+','+ 
  'CUPONES X COBRAR'+','+ 'HECHO DE MKT'+','+ 'FECHA U.H.'+','+ 'PRECIO TEORICO'+','+ 'POST COMPRA'+','+ 'POST VENTA'+','+ 'YIELD COMPRA'+','+ 'YIELD VENTA'+','+ 'SPREAD COMPRA'+','+ 'SPREAD VENTA'+','+ 'MDYS'+','+ 'S&P'+','+ 'BURSATILIDAD'+','+ 
  'LIQUIDEZ'+','+ 'CAMBIO DIARIO'+','+ 'CAMBIO SEMANAL'+','+ 'PRECIO MAX 12M'+','+ 'PRECIO MIN 12M'+','+ 'SUSPENSION'+','+ 'VOLATILIDAD'+','+ 'VOLATILIDAD 2'+','+ 'DURACION'+','+ 'DURACION MONET.'+','+ 'CONVEXIDAD'+','+ 'VAR'+','+ 'DESVIACION STAND'+','+ 'VALOR NOMINAL ACTUALIZADO'+','+ 'CALIFICACION FITCH'+','+ 'FECHA PRECIO MAXIMO'+','+ 'FECHA PRECIO MINIMO'+','+ 'SENSIBILIDAD'+','+ 'DURACION MACAULAY'+','+ 'TASA DE RENDIMIENTO'+','+ 'HR RATINGS'+','+ 'DURACION EFECTIVA'+','+ 'ISIN'+','+ 'Precio Sucio MO'+','+ 
  'Precio Limpio MO'+','+'Intereses Acumulados MO')  
...
+','+LTRIM(txtMOC)+','+LTRIM(txtISD)+','+LTRIM(txtTTM)    
+','+txtMTD+','+LTRIM(txtNOM)+','+LTRIM(txtCUR )   
