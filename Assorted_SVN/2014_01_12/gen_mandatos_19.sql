...
-- Fecha:	   2014-11-24 11:57:53.310
-- Objectivo:Corregir campo VCT para reportar dos enteros, 8 decimales  
--------------------------------------------------  
*/
 
   ALTER   PROCEDURE [dbo].[usp_productos_PiPGenericos];19  
   @txtDate AS DATETIME   --= '20141031'
