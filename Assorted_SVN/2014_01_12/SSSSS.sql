...
WHERE txtProcess LIKE '%var%'
AND txtParameter = 'TMPTableName'
...
--SELECT * FROM  tmp_tblVarHechosIRS
--SELECT * FROM  tmp_tblVarHechosPrivados
--SELECT * FROM  tmp_tblVarHechosRevOnLine
SELECT * FROM  tmp_tblVarPosturasOnLine
WHERE TXTTV = 'S'
...
WHERE intPlazo = 2295
AND dteDate = '20140829'
AND intIdBroker = 7


SELECT * FROM  dbo.itblBrokerCatalog
WHERE txtBroker LIKE'%VAR%'

SELECT * FROM tmp_tblVarPosturasRevOnLine

    
--CREATE  PROCEDURE dbo.spi_Auditoria_Licuadora;1    
 DECLARE @txtDate AS CHAR(10)   ='20140829'  
 DECLARE @intPlazo AS INT = 2295
