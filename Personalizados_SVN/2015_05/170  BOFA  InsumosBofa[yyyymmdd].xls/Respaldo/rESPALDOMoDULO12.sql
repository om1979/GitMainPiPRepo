...
ALTER   PROCEDURE [dbo].[sp_productos_BOFA];12   '20150520'       
...
-- Creación de Directivas para obtener información                
 ...
 /*AGREGAN TITULOS DEL ARCHIVO*/              
  INSERT @tblDirectives           SELECT 01,'BOFA',1,'IRC', 'Index.Basis.1m',  2, 7,'',NULL,NULL,NULL,NULL   UNION               
   ...
   SELECT 01,'BOFA',1,'IRC', 'Index.Basis.12y', 2, 16,'',NULL,NULL,NULL,NULL UNION             SELECT 01,'BOFA',1,'IRC', 'Index.Basis.15y', 2, 17,'',NULL,NULL,NULL,NULL UNION                
   ...
   SELECT 01,'BOFA',1,'IRC', 'Funding.Cash.3M',  2, 23,'',NULL,NULL,NULL,NULL UNION           SELECT 01,'BOFA',1,'IRC', 'Funding.Future.',  2, 24,'',NULL,NULL,NULL,NULL UNION                
...
SELECT 01,'BOFA',2,'IRC', 'Funding.Future7', 6, 27, NULL,NULL,NULL,NULL,NULL UNION             
 ...
 SELECT 01,'BOFA',2,'IRC', '', 6, 43, NULL,NULL,NULL,NULL,NULL UNION             
  ...
  SELECT 01,'BOFA',2,'VALORFIJO', 'Turn.Bump.20101231', 6, 44, '0.34125',NULL,NULL,NULL,NULL UNION            SELECT 01,'BOFA',2,'VALORFIJO', 'Turn.Bump.20111230', 6, 45, '0.34125',NULL,NULL,NULL,NULL UNION                
...
SELECT 01,'BOFA',5,'VALORFIJO', 'Funding.Basis.20Y',15, 29,'0.0000',NULL,NULL,NULL,NULL UNION                
 ...
 SELECT 01,'BOFA',6,'VALORFIJO', 'Funding.Basis.3Y', 18, 22,'0.0000',NULL,NULL,NULL,NULL UNION                
  ...
  SELECT 01,'BOFA',6,'VALORFIJO', 'Funding.Basis.7Y', 18, 25,'0.0000',NULL,NULL,NULL,NULL UNION                  SELECT 01,'BOFA',6,'VALORFIJO', 'Funding.Basis.10Y',18, 26,'0.0000',NULL,NULL,NULL,NULL UNION                
...
------             
 ...
 INSERT @tblDirectives               
  ...
  SELECT 01,'BOFA',10,'IRC-','OIS390',30,21,NULL,NULL,NULL,NULL,NULL                           
