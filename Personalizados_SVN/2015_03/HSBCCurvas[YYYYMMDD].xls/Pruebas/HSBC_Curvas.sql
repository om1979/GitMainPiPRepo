...
Modifica:Omar Adrian Aceves Gutierrez 
Fecha:2015-03-05 10:02:54.300
Nota: SE AGREGA Implícita en Forward de Rublo Ruso,Puntos Forward RUB/USD
------------------------------------------------------
*/
...
--SET @txtDate = '20140214'
	...
	INSERT @tmpLayoutxlCurve 
		...
		SELECT 'Sheet1' AS [SheetName], 99 AS [Col],'Implicita CNH'  AS [Header],'CURVES' AS [Source],'FWD'    AS [Type],'CNH'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad] UNION
		SELECT 'Sheet1' AS [SheetName], 100 AS [Col],'Implícita en Forward de Rublo Ruso'  AS [Header],'CURVES' AS [Source],'FTC'    AS [Type],'RUB'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad]  UNION 
		SELECT 'Sheet1' AS [SheetName], 101 AS [Col],'Puntos Forward RUB/USD'  AS [Header],'CURVES' AS [Source],'FWP'    AS [Type],'RUB'    AS [SubType],'-999'     AS [Range],'0.01'     AS [Factor], 'DBL' AS [DataType], '0.000000'           AS [DataFormat],'1' AS [fLoad]
