...
--where txtvalor like '%VIA[DATE|YYYYMMDD]%'
--and txtPropiedad = 'FileName'

--VIA[DATE|YYYYMMDD].PIP
 

--select * from tblactivex
--where txtProceso = 'CONSAR_VI_TXT'
...
----tblactivex
--txtProceso					txtPropiedad		txtTipo			txtValor
--CONSAR_VI_TXT			FileName				STR				CONSAR_VI[DATE|YYYYMMDD].txt		sp_clsOfficialIndexFiles;13 '[DATE|YYYYMMDD]','1'
--CONSAR_NEW_VI_PIP 	FileName				STR              Nuevo_CONSAR_VI[DATE|YYYYMMDD].PIP
...
ALTER  PROCEDURE dbo.sp_clsOfficialIndexFiles;13  
